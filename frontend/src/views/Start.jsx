...
function Start() {
  //Hier rufe ich die im contextprovider bestimmte Variable setPlayerName&nutze sie in Zeile 29
      ...
      <div className="relative min-h-screen z-10">
        <div className="inner-container">
          ...
          <form onSubmit={handleSubmit}>
            <label
              className="block text-center text-amber-500/60 tracking-widest text-xl"
              htmlFor="myInput"
            >
              INSERT YOUR NAME
            </label>
